...
//       <h4 className='text-center'>Employye Details of {player.name} {player.lname}</h4>
      
//       <div>
//       <h4 className='empid'>Employee ID : {player.number}</h4>
    
//       <Link to={`/resume/${player.name}`} name='name'><b>Flip to Resume</b></Link>
//       <Link  onClick = {onpressmeth}><b>Flip to Resume2</b></Link>   
//       </div>
//       <hr/>
...
//       </div>
//        <hr/>
//        <div className='res'><Resume name={player.name}/></div>
//     </div>  
//   )
// }
